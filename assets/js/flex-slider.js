    ...
    $(window).ready(function() {
        ...
        $('.flexslider').flexslider({
            ...
            start: function(slider) {
                ...
                sliderMain.find('.item').css({
                    top: topimage
                });
                sliderMain.find('.item').animate({
                    right: '0',
                    opacity: '1'
                }, 1000);
                sliderMain.find('.fade-flex').css({
                    top: topfade
                });
                sliderMain.find('.fade-flex').animate({
                    opacity: '1'
                }, 1000);
                sliderMain.find('.flex-top-bot').animate({
                    left: '0',
                    top: toptitle,
                    opacity: '1'
                }, 1500);
                sliderMain.find('.flex-bot-top').animate({
                    left: '0',
                    bottom: bottomtext,
                    opacity: '1'
                }, 1500);
                sliderMain.find('.links').css({
                    bottom: bottomlinks
                });
                sliderMain.find('.links').animate({
                    left: '0',
                    opacity: '1'
                }, 1800);
